...
extends below the header so the glow still bleeds over the following hero; page
files MUST NOT add navy or overflow wrappers to contain it), the footer, the
