...
Observed: `R3 D2 C2 E2 L2 S2 Y2 P2 U1 T1 A2`; `O` are below their
lowest defined level.
Eleven dimensions meet their agreed level and one are short.
Ten dimensions meet their agreed level and two are short.
